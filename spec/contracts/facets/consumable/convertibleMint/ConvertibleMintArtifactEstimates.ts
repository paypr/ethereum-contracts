...
export const convertibleMintArtifactEstimateTests: EstimateTest[] = [
  [
    'ConsumableConvertibleMintArtifact',
    async () => ({
      diamondCuts: [buildDiamondFacetCut(await deployConsumableConvertibleMintArtifactFacet())],
      initFunction: emptyDiamondInitFunction,
    }),
    170609,
  ],
  [
    'ConsumableConvertibleMintArtifact with one combination',
    async () => ({
      diamondCuts: [buildDiamondFacetCut(await deployConsumableConvertibleMintArtifactFacet())],
  ...
  [
    'ConsumableConvertibleMintArtifact with two combinations',
    async () => ({
      diamondCuts: [buildDiamondFacetCut(await deployConsumableConvertibleMintArtifactFacet())],
      initFunction: buildConsumableConvertibleMintSetCombinationsFunction(await deployConsumableConvertibleMintInit(), [
        {
