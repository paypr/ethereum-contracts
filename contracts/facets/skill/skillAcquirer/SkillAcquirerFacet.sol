...
import './ISkillAcquirer.sol';
import './SkillAcquirerImpl.sol';

contract SkillAcquirerFacet is ISkillAcquirer {
  function acquireNext(
    ...
    SkillAcquirerImpl.checkAdmin();

    SkillAcquirerImpl.acquireNext(skill, useItems, amountsToProvide);
  }
}
