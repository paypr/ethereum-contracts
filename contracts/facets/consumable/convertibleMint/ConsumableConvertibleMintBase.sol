...
abstract contract ConsumableConvertibleMintBase is IConsumableConvertibleMint {
  function isValidConsumableCombination(IConsumable[] calldata consumables)
    external
    view
    virtual
    override
  ...
  function validConsumableCombinations() external view virtual override returns (ConsumableCombination[] memory) {
